...
- Ключ вершины больше всех ключей своего левого поддерева и меньше всех ключей правого поддерева <picture>  
...
#### erase
Функция `erase` удаляет элемент из дерева, если он в нём есть.  
